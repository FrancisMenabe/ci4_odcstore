...
<title>Historique des Paiements | ODC STORE</title>
...
<div class="content">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?= base_url('paiements-solaire/new') ?>" class="btn btn-orange">
            <i class="fa-solid fa-plus"></i> Nouveau Paiement
        </a>
    </div>

    <div class="table-wrapper">
        <table id="paiementsTable" class="table table-bordered table-hover bg-white">
            ...
            <?php if(!empty($paiements)): ?>
                ...
                <tr>
                    ...
                    <td><?= $p['client_nom'] ?></td>
                    <td><?= $p['client_tel'] ?></td>
                    <td><?= date('m/Y', strtotime($p['mois_paye'])) ?></td>
...
$(document).ready(function() {
    $('#paiementsTable').DataTable({
        ...
        "order": [[5, "desc"]], // Trier par date de paiement décroissante
        "pageLength": 10,
